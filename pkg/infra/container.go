...
func Inject(c container.Container) error {
	return common.InjectAll(c, ioc.InjectIoc, mongodb.InjectGameRepository, mongodb.InjectGameModeRepository, mongodb.InjectRegionRepository, mongodb.InjectCommitmentRepositories, squad.Inject, billing.Inject, iam.Inject, InjectKafka)
}
